...
const RestaurantDataFlowSection = () => {
  return <section className="py-24 bg-gradient-to-b from-white to-gray-50 relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
            ...
            <div className="relative">
              ...
              delay: 0.4
                ...
                <h3 className="text-xl font-semibold text-center mb-2">Tu Facturador</h3>
