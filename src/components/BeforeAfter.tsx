      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 relative">
        ...
        >
          ...
          >
            Automatización que{" "}
            <motion.span 
              className="font-light bg-gradient-to-r from-primary via-primary to-primary/80 bg-clip-text text-transparent"
              initial={{ opacity: 0 }}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 relative">
          ...
          <motion.div
            className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-24 h-px bg-gradient-to-r from-red-200 via-gray-300 to-primary/30 hidden lg:block"
          ...
          >
            <motion.div 
              className="p-10 bg-gray-50/50 rounded-3xl border border-gray-200/50 backdrop-blur-xl relative overflow-hidden"
              whileHover={{
            ...
            >
              ...
              <motion.div
                className="absolute inset-0 bg-gradient-to-br from-red-50/30 via-transparent to-red-50/20 opacity-0"
          ...
          >
            <motion.div 
              className="p-10 bg-gradient-to-br from-primary/5 via-primary/10 to-primary/5 rounded-3xl border border-primary/20 backdrop-blur-xl relative overflow-hidden"
              whileHover={{
            ...
            >
              {/* Subtle hover glow */}
              <motion.div
                className="absolute inset-0 bg-gradient-to-br from-primary/10 via-purple-500/5 to-primary/10 opacity-0"
                whileHover={{ opacity: 1 }}
                transition={{ duration: 0.3 }}
              />
