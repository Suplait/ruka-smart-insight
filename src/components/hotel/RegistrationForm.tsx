...
export default function RegistrationForm({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      trackFormSubmission('hotel_registration', {
      ...
      try {
        const slackResponse = await supabase.functions.invoke('notify-slack', {
          body: {
            ...
            industryType: 'hotel' // Specify that this is a hotel lead
          }
        });
      ...
      trackRegistration({
        lead_id: leadId,
        hotel_name: formData.nombreHotel
      }, true);
      ...
      setTimeout(() => {
        navigate('/onboarding-success', {
          state: {
            restaurantName: formData.nombreHotel, // Using the same state property for compatibility
            leadId: leadId
          }
        });
      }, 100);
