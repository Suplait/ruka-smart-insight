    ...
    <header className="relative px-5 pb-16 pt-24 sm:px-8 sm:pb-20 lg:pb-24">
      <div className="mx-auto max-w-7xl">
        <div className="grid items-center gap-12 lg:grid-cols-[0.92fr_1.08fr] lg:gap-14 xl:gap-20">
          ...
          >
            <p className="text-[11px] font-semibold tracking-[0.18em] text-[#5369eb]">{worksContent.hero.eyebrow}</p>
            ...
            <div id="works-hero-actions" className="mt-8 flex flex-col items-start gap-3 sm:flex-row sm:items-center">
              <Link
            ...
            <p className="mt-3 text-xs font-medium text-[#767d8d]">{worksContent.hero.microcopy}</p>
          </motion.div>
